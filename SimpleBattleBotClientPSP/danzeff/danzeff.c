...
//int danzeff_screen_rect_x;
//int danzeff_screen_rect_y;
//int danzeff_screen_rect_w;
//int danzeff_screen_rect_h;
//
//
...
//void surface_draw_offset(Image* pixels, int screenX, int screenY, int offsetX, int offsetY, int intWidth, int intHeight)
//{
...
//	blitAlphaImageToScreen(danzeff_screen_rect_x, danzeff_screen_rect_y, intWidth, intHeight, pixels, danzeff_screen_rect_x, danzeff_screen_rect_y);
//}
//
/////Draw a surface at the current moved_x, moved_y
//void surface_draw(Image* pixels)
//{
//	surface_draw_offset(pixels, 0, 0, 0, 0, pixels->imageWidth, pixels->imageHeight);
//}
//
...
//	{
//		keyBits[a] = loadImage(guiStrings[a]);
//		if (keyBits[a] == NULL)
//		{
//			printf("Error while loading image %C at spot %i", guiStrings[a], a);
...
//void danzeff_render()
//{
//	pspDebugScreenPrintf("Drawing Keyboard at %i,%i\n", selected_x, selected_y);
//	dirty = false;
//	
