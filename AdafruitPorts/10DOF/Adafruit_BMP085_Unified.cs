...
namespace AdafruitPorts._10DOF
{
    class Adafruit_BMP085_Unified
    {
        ...
        */
        /**************************************************************************/
        public Adafruit_BMP085_Unified(I2cDriver I2CDevice, int sensorID)
        {
            _sensorID = sensorID;
            this.I2CDev = I2CDevice.Connect(BMP085_ADDRESS);
