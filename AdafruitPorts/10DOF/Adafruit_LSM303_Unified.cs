...
namespace AdafruitPorts._10DOF
{
    /***************************************************************************
    ACCELEROMETER
    ***************************************************************************/
    ...
    {
        // I2C Device
        private I2cDeviceConnection I2CDev;
        /*=========================================================================
        I2C ADDRESS/BITS
        -----------------------------------------------------------------------*/
        ...
        */
        /**************************************************************************/
        public Adafruit_LSM303_Accel_Unified(I2cDriver I2CDevice, int sensorID = -1)
        {
            _sensorID = sensorID;
            this.I2CDev = I2CDevice.Connect(LSM303_ADDRESS_ACCEL);
        }
    ...
    -----------------------------------------------------------------------*/
        ...
        */
        /**************************************************************************/
        public Adafruit_LSM303_Mag_Unified(I2cDriver I2CDevice, int sensorID = -1)
        {
            _sensorID = sensorID;
            _autoRangeEnabled = false;
            this.I2CDev = I2CDevice.Connect(LSM303_ADDRESS_MAG);
        }
